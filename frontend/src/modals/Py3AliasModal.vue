...
<template>
  <VueFinalModal modalId="theInputModal" class="swiflow-modal-wrapper" content-class="modal-content modal-content-flex"
...
.form-control-flex {
  flex: 1;
  resize: none;
  /* Disable manual resize since it will auto-fill */
  min-height: 260px;
