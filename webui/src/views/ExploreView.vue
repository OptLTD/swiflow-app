...
<template>
  <div class="h-full flex flex-col bg-white">
    ...
    <div class="shrink-0 border-b border-neutral-200 px-4 py-2 flex items-center gap-2 text-sm">
      <SvgIcon name="folder-open" class="text-neutral-400" />
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div v-else-if="!entries.length" class="p-6 text-neutral-400">Empty directory</div>
      <div v-else>
        <button
        ...
        >
          <SvgIcon :name="entry.is_dir ? 'folder' : 'file'" class="text-neutral-400" />
