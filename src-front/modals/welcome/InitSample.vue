...
const sampleTasks = [
  ...
  },
  {
    ...
    brief: '请对我的代码进行全面审查，检查代码规范、性能问题、安全漏洞，并提供具体的改进建议。请对我的代码进行全面审查，检查代码规范、性能问题、安全漏洞，并提供具体的改进建议。请对我的代码进行全面审查，检查代码规范、性能问题、安全漏洞，并提供具体的改进建议。',
  ...
  },
  {
    ...
    brief: '请帮我设计和执行API接口的自动化测试，包括功能测试、性能测试和边界条件测试。请帮我设计和执行API接口的自动化测试，包括功能测试、性能测试和边界条件测试。请帮我设计和执行API接口的自动化测试，包括功能测试、性能测试和边界条件测试。请帮我设计和执行API接口的自动化测试，包括功能测试、性能测试和边界条件测试。',
