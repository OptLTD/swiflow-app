...
| [cloudflare-worker-dl.md](cloudflare-worker-dl.md) | CDN：`dl.option.ltd/swiflow/`（共用 Worker）。 |
| [cloudflare-worker-dl.js](cloudflare-worker-dl.js) | Cloudflare Worker 源码（多产品 `/{product}/`）。 |
